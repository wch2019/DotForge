<template>
  <n-modal :show="show" preset="card" style="width: 800px; max-width: 90vw;" :mask-closable="false" @update:show="handleShowUpdate">
    <template #header>
      <div class="modal-header">
        <h2 class="modal-title">应用设置</h2>
        <n-button quaternary circle size="small" @click="closeModal">
...
import { NModal, NTabs, NTabPane, NInput, NButton, NSelect, NSwitch, NInputNumber, NIcon } from 'naive-ui'
